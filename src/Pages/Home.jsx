...
function Home()
 {
  return (<body>
    ...
    <Herobanner/>
       ...
       <div className='sm:flex sm:gap-10 sm:mx-12'> 
         <div className=' w-full  h-[1200px] overflow-y-hidden  my-10  sm:mb-0 mb-32  flex  flex-col gap-10 sm:overflow-auto '>   <Tranding/> <Upcaming/> </div>
    <Mostrated/>
    </div>
