...
const UpcomingCard = ({ movie, genres }) => {
  ...
  return (
    <motion.div
      ...
      className="rounded-md w-72 h-[410px] m-5 sm:m-2 bg-opacity-20 cursor-pointer overflow-hidden bg-[#666666] "
      style={{
        borderRadius: '4px',
        padding: '10px',
      ...
      whileHover={{
        background:
          'linear-gradient(#141414 , #141414 ) 50% 50%/calc(100% - 7px) calc(100% - 7px) no-repeat, linear-gradient(90deg, red 0%, purple 100%)',
        scale: 1.01,
      }}
    >
      <div className="overflow-hidden relative">
        ...
        />
        <motion.div
          className="absolute top-0 right-0 px-3 pt-2 z-30"
          initial={{ opacity: 0.7 }}
    ...
    >
      <h2 className="text-sm font-light opacity-60 pl-1">
       ...
       <span className="bg-white h-fit flex mx-2 w-fit px-2 rounded-xl bg-opacity-20 text-text opacity-60">
        ...
        <h2 className="text-lg font-bold mb-2 ml-5 text-text">
