    ...
    return (
      <div className="rounded-full drop-shadow-2xl mr-3">
        <Link
          ...
          onMouseOver={handlehoverdown}
          onMouseLeave={handlehoverup}
        >
          <motion.button whileHover={{ scale: 1.1 }}>
            <CgProfile size={45} color="white" width={30} />{' '}
          </motion.button>
          <motion.div
            className="text-text text-xl absolute  w-20   -right-6"
        ...
        <Link to="/Signin" className="sm:hidden block mr-6 mt-1">
          <motion.button whileHover={{ scale: 1.1 }}>
            <CgProfile size={35} color="white" width={30} />{' '}
          </motion.button>{' '}
        </Link>
      </div>
    );
